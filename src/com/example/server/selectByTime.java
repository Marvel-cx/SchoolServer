...
/**
 * Servlet implementation class selectByTime
 */
public class selectByTime extends HttpServlet {
        ...
        try {
 			...
 			if(list!=null){	
		        ...
		        writer.close();
 				...
 				json.append("[");
 				json.append("{");
 				json.append("'data':").append("'").append("nodata").append("'");
 				json.append("}");
 				json.append("]");
 				PrintWriter writer=response.getWriter();
 		        writer.print(jsonp+"("+json+")");
